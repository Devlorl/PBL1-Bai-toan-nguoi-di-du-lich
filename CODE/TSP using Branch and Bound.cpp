...
void getfile(canh a[][size], int *n){
	...
	FILE *f;
	scanf("%d",&v);
	if(v==1)	f=fopen("F:\\TEST & RESULT\\TEST1.txt","r");
	if(v==2)	f=fopen("F:\\TEST & RESULT\\TEST2.txt","r");
	if(v==3)	f=fopen("F:\\TEST & RESULT\\TEST3.txt","r");
	if(v==4)	f=fopen("F:\\TEST & RESULT\\TEST4.txt","r");
	if(v==5)	f=fopen("F:\\TEST & RESULT\\TEST5.txt","r");
	if(v==6)	f=fopen("F:\\TEST & RESULT\\TEST6.txt","r");
	if(v==7)	f=fopen("F:\\TEST & RESULT\\TEST7.txt","r");
	if(v==8)	f=fopen("F:\\TEST & RESULT\\TEST8.txt","r");
	if(v==9)	f=fopen("F:\\TEST & RESULT\\TEST9.txt","r");
	if(v==10)	f=fopen("F:\\TEST & RESULT\\TEST10.txt","r");
	if(f == NULL){
		TextColor(4);
...
void fileout(canh a[][size], canh PA[], int n, float *sum){
	int i;
	FILE *fo= fopen("F:\\TEST & RESULT\\RESULT.OUT","w");
